...
- (void)viewDidLoad
{
    ...
    // 导航条
    UIImageView *imageViewNavBar = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:@"composeupbg.png"]];
...
//    viewWordNum.wordsNum = MaxInputWords;
    ...
    imageviewRim.image = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composepic_biankuang.png"]];
    ...
    imageView.image = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composevideo_pic.png"]];
    ...
    [btnStart setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"repeatVideoStarticon.png"]] forState:UIControlStateNormal];
