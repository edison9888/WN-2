...
- (void)viewDidLoad
{
    ...
    // 导航条
    UIImageView *imageviewNavigation = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeupbg.png"]]];
    ...
    [buttonBack setBackgroundImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composequxiaobtn.png"]] forState:UIControlStateNormal];
...
- (UITableViewCell *)createFriendCell:(UITableView *)tableView identifier:(NSString *)strIdentifier indexPath:(NSIndexPath *)indexPath  data:(NSMutableDictionary *)dicItem {
    ...
    if (imagePortrait == nil ) {
        ...
        // 网络请求数据
            ...
            // 加载默认图片
            UIImage *imagePortrait = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"friendPortrait.png"]];
            [imageviewPortrait setImage:imagePortrait];
    ...
    UIImage *imageSeparator = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"separatorLine.png"]];
...
- (UITableViewCell *)createKeyCell:(UITableView *)tableView identifier:(NSString *)strIdentifier  data:(NSDictionary *)dicItem {
    ...
    UIImage *imageSeparator = [[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"separatorLine.png"]] stretchableImageWithLeftCapWidth:1 topCapHeight:1];
    [imageviewSeparator setImage:imageSeparator];
