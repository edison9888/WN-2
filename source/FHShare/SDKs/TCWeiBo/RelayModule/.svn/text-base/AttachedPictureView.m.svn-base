...
-(void)setAttachedImage:(UIImage *)attachedImage {
    ...
    [frameBtn setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeImageFrame.png"]] forState:UIControlStateNormal];
	[frameBtn setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeImageFrame.png"]] forState:UIControlStateHighlighted];
