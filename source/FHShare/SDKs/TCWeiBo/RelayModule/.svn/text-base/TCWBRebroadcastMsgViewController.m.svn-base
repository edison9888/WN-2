...
- (void)viewDidLoad
{
    ...
    // 导航条
    UIImageView *imageViewNavBar = [[UIImageView alloc] initWithImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeupbg.png"]]];
    ...
    [buttonLeft setBackgroundImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composequxiaobtn.png"]] forState:UIControlStateNormal];
	...
	[buttonRight setBackgroundImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composesentbtn.png"]] forState:UIControlStateNormal];
    [buttonRight setBackgroundImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composesentbtnhover.png"]] forState:UIControlStateHighlighted];
	...
	imageViewPlaceBtn.image = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeiconbg.png"]];
    ...
    viewDownBase.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeEmotionBg"]]];
	[self.view addSubview:viewDownBase];
   
    // 照相机
    UIButton *btnPhotoFromCamera = [UIButton buttonWithType:UIButtonTypeCustom];
	[btnPhotoFromCamera setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeCameraEnable.png"]] forState:UIControlStateNormal];
	[btnPhotoFromCamera setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeCamerahover.png"]] forState:UIControlStateHighlighted];
    ...
    [btnPosition setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composedingwei.png"]] forState:UIControlStateNormal];
	...
	[btnFriendsSearch setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeAt.png"]] forState:UIControlStateNormal];
	[btnFriendsSearch setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeAthover.png"]] forState:UIControlStateHighlighted];
	...
	[btnTopicSearch setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"compose#.png"]] forState:UIControlStateNormal];
	[btnTopicSearch setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"compose#hover.png"]] forState:UIControlStateHighlighted];
...
- (void)positionBtnClicked:(id)sender {
    ...
    if (bShowPosition) {    // 显示地理位置开关打开,并去获取经纬度
        ...
        [button setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composedingwei.png"]] forState:UIControlStateNormal];
        self.myLocation = nil;
        bShowPosition = YES;
    }
}
...
- (void)stopLoading {
    ...
    if (self.myLocation != nil) {
        [button setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composedingweihover.png"]] forState:UIControlStateNormal];// 获取位置信息成功，图标变亮
        bShowPosition = NO;
    }
}
