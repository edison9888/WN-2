...
- (void)attachImage:(UIImage *)imageRef {
	...
	baseView.image = [UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composepic_biankuang.png"]];
	...
	[DelBtn setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeImageDel.png"]] forState:UIControlStateNormal];
	[DelBtn setImage:[UIImage imageWithContentsOfFile:[MHFile getResourcesFile:@"composeImageDel.png"]] forState:UIControlStateHighlighted];
